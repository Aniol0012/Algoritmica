...
def help_panel():
    print("Usage: python3 ./encoder_it.py <key> <EX_plain_text.txt> <EX_encoded_text.txt>")
...
for length in lengths:
    uncyphered_text = plain_text * length
    start_time = time.time()
    encoder(uncyphered_text)
    end_time = time.time()
